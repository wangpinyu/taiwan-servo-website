...
const moduleNameRules = [
  { patterns: [/產品型號規格詳情/g, /產品型號規格/g, /產品型號與規格/g, /熱門產品型號/g, /重點產品型號/g, /特殊產品型號/g, /產品分類與特點/g, /產品系列特色/g, /產品系列規格詳情/g, /系列導覽/g, /型號導覽/g], name: '產品系列' },
  { patterns: [/各系列主要規格/g, /產品規格詳細資料/g, /產品規格詳情/g], name: '產品規格詳情' },
  { patterns: [/推薦應用領域\s*\([^)]*\)/g, /行業應用實例\s*\([^)]*\)/g, /行業應用實績\s*\([^)]*\)/g, /核心應用領域\s*\([^)]*\)/g, /主要應用市場/g, /主要應用領域/g, /典型應用場景/g, /應用場景建議/g, /應用實例與經驗/g, /應用建議與總結/g, /應用建議/g, /適用應用/g, /應用案例/g, /應用領域/g], name: '應用領域' },
...
const specHeadingPatterns = [/產品規格詳情/, /各系列主要規格/];
const applicationHeadingPatterns = [/應用領域/, /主要應用領域/, /適用應用/, /應用案例/, /Industry Applications/i, /Applications/i];
